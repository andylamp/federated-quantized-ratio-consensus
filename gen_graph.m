...
%
% This function is responsible for generating a graph and returns its
% adjacency matrix. Optionally, it can return its distance (also known as
% diameter), the number of nodes, as well as the full adjacency matrix.
%
% It is parameterised to for offering fully/weakly connected graphs while
% generating it using randomized methods.
%
%
